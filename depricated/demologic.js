...
$("#hostBtn").click(function() {
  ...
  .send({from: web3.eth.defaultAccount, nonce: correctNonce, gas: 3000000, gasPrice: Math.ceil(gasPriceChoice)*1000000000},
    ...
    if(receipt.status === true){
      ...
      $('#promoField').hide();
      $("#createSuccess").show();
      $("#chalID").html('Payment complete. Your goal has been created and now lives forever on the Blockchain! <br>View it now: <a style="color:#ccff00;" target="_blank" href="https://ropsten.etherscan.io/tx/'+eshash+'">click here</a>.');
