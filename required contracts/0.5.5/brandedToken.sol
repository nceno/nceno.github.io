...
contract ERC20Basic {
  ...
  function balanceOf(address who) constant view returns (uint256);
...
contract BasicToken is ERC20Basic {
  ...
  */
  function balanceOf(address _owner) constant view returns (uint256 balance) {
...
//-------------customize this
///////////
contract BrandedToken is StandardToken, ERC677Token {
  uint public constant totalSupply = 10**27;
  string public constant name = 'Branded Token';
  uint8 public constant decimals = 18;
  string public constant symbol = 'RPT';
  function BrandedToken() public{
